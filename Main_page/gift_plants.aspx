<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gift_plants.aspx.cs" Inherits="PLANTS.Main_page.gift_plants" EnableEventValidation="false"%>
...
<div class="box-container">
    ...
    <div class="box">
        ...
        <img src="../Images/new products/gift/gift (5).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
    ...
    <div class="box">
        ...
        <img src="../Images/new products/gift/gift (2).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
    ...
    <div class="box">
        ...
        <img src="../Images/new products/gift/gift (6).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
    ...
    <div class="box">
        ...
        <img src="../Images/new products/gift/gift (1).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
    ...
    <div class="box">
        ...
        <img src="../Images/new products/gift/gift (3).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
    ...
    <div class="box">
        ...
        <img src="../Images/new products/gift/gift (4).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
