<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="plants_for_house.aspx.cs" Inherits="PLANTS.Main_page.plants_for_home" EnableEventValidation="false"%>
...
<div class="box-container">
    ...
    <div class="box">
        ...
        <img src="../Images/new products/home/home (1).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
    ...
    <div class="box">
        ...
        <img src="../Images/new products/home/home (2).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
        ...
        <div class="price">₹99 <span>₹160</span></div>
    ...
    <div class="box">
        ...
        <img src="../Images/new products/home/home (3).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
        ...
        <span class="discount">-10%</span>
        <div class="icons">
           <asp:LinkButton ID="LinkButton1" runat="server" OnClick="AddToWishList_Click"><i class="fas fa-heart"></i></asp:LinkButton>                        
            
        </div>
        <img src="../Images/new products/home/home (4).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
        ...
        <div class="price">₹99 <span>₹150</span></div>
        <asp:Button ID="Button1" CssClass="btn1" runat="server" Text="add to cart" />
    </div>

    <div class="box">
        <span class="discount">-25%</span>
        <div class="icons">
           <asp:LinkButton ID="LinkButton2" runat="server" OnClick="AddToWishList2_Click"><i class="fas fa-heart"></i></asp:LinkButton>                        
            
        </div>
        <img src="../Images/new products/home/home (5).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
        ...
        <div class="price">₹99 <span>₹160</span></div>
        <asp:Button ID="Button2" CssClass="btn1" runat="server" Text="add to cart" />
    </div>

    <div class="box">
        <span class="discount">-7%</span>
        <div class="icons">
            <asp:LinkButton ID="LinkButton3" runat="server" OnClick="AddToWishList3_Click"><i class="fas fa-heart"></i></asp:LinkButton>                        
          
        </div>
        <img src="../Images/new products/home/home (6).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
        ...
        <div class="price">₹99 <span>₹150</span></div>
        <asp:Button ID="Button3" CssClass="btn1" runat="server" Text="add to cart" />
    </div>
