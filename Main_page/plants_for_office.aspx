<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="plants_for_office.aspx.cs" Inherits="PLANTS.Main_page.plants_for_office" EnableEventValidation="false"%>
...
<h1 class="heading"> plants for office </h1>
...
<div class="box-container">
    ...
    <div class="box">
        ...
        <img src="../Images/new products/office/office (1).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
    ...
    <div class="box">
        ...
        <img src="../Images/new products/office/office (2).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
    ...
    <div class="box">
        ...
        <img src="../Images/new products/office/office (3).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
    ...
    <div class="box">
        ...
        <img src="../Images/new products/office/office (4).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
    ...
    <div class="box">
        ...
        <img src="../Images/new products/office/office (5).jpg" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
        ...
        <div class="price">₹99 <span>₹190</span></div>
    ...
    <div class="box">
        ...
        <img src="../Images/new products/office/office (6).png" alt="" />
        <h3>latest plants</h3>
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
